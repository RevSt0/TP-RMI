...
public class MachineForm extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        SalleBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SalleBoxActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(SalleBox, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void SalleBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SalleBoxActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_SalleBoxActionPerformed
    ...
    private void bnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnUpdateActionPerformed
        try {
            ...
            Object salle = SalleBox.getSelectedItem();
            int salleId = Integer.parseInt(salle.toString().split(",")[0].split("=")[1]);
            machine.setSalle(daoS.findById(salleId));
            dao.update(machine);
            load();
        }
        catch (RemoteException ex) {
